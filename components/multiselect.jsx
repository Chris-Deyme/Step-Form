...
const MultiSelectContext = createContext(null > null);
    ...
    return (
      <div className="relative w-full">
        <div
          ref={ref}
          className={cn(
            "flex flex-wrap gap-1 rounded-lg bg-background",
            className
          )}
          {...props}
        >
        ...
        <div className="top-full left-0 w-full mt-2 flex flex-wrap gap-1">
          {value.map((item, index) => (
            <Badge
              key={item}
              className={cn(
                "px-1 rounded-none py-2 m-1 flex items-center gap-1",
